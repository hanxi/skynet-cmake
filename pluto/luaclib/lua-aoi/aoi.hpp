...
namespace pluto
{
    ...
    public:
        ...
        struct aoi_event
        {
            ...
            aoi_event(int eid, object_handle_type w, object_handle_type m) : eventid(eid),
                                                                             watcher(w),
                                                                             marker(m) {}
        };
    ...
    public:
        aoi(int posx, int posy, int map_size, int tile_size) : rect_(posx, posy, map_size, map_size),
